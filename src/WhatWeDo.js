  ...
  return (
    <div className="">
      <section className="">
        ...
        <div
          className=""
          style={{ height: "100px", backgroundColor: "rgba(0, 0, 0, 0.76)" }}
        ></div>
        {/* banner */}
        <div
          className=""
          style={{
            background: "url(images/banner-2.png) no-repeat scroll left/cover",
            height: "400px",
            width: "100%",
          }}
        >
              ...
              <div className="col-10 col-md-5">
                <div
                  ...
                  style={{
                    height: "400px",
                    background:
                      "url(images/computer-screen.png) no-repeat scroll center/contain",
                  }}
                ></div>
              </div>
              {/* Words */}
              <div className="col-10 col-md-5">
                <div
                  ...
                  style={{
                    height: "400px",
                    background:
                      "url(images/unleashing.png) no-repeat scroll center/contain",
                  }}
                ></div>
              </div>
            </div>
        ...
        <div className="container ">
          <div className="row justify-content-center">
            <div className="col-md-8 col-lg-6 text-center">
              <div className="section-heading">
                ...
                {/* Subheading */}
                <p>
                  Our software development process relies on incremental
                  development
                </p>
              </div>
            </div>
          ...
          <div className="row justify-content-around g-5 g-md-auto">
            <div className="col-10 col-md-6 col-lg-4 col-xxl-3">
              <div className="item1">
                <div
                  className="part1 bg-white"
                  style={{
                    width: "100%",
                    height: "40%",
                    backgroundImage:
                      "url(images/icons/requirement-analysis.png)",
                ...
                >
                  ...
                  <p>
                    ...
                    possibility, and collect data as part of the feasibility
                    study
                  </p>
            ...
            <div className="col-10 col-md-6 col-lg-4 col-xxl-3">
              <div className="item1">
                ...
                >
                  ...
                  <p>
                    The development of Customer Software architecture will
                    require several experts in the field of software development
                  </p>
            ...
            <div className="col-10 col-md-6 col-lg-4 col-xxl-3">
              <div className="item1">
                ...
                >
                  ...
                  <p>
                    We start with a prototype to align with specifications,
                    remove design drawbacks, make changes based on customer
                    requirements.
                  </p>
                  <button className="invRead">READ MORE</button>
                </div>
